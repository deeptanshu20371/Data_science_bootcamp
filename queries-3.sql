...
-- fetch 
SELECT COUNT(DISTINCT Customer_id) AS Total_Customers, AVG(Total_Revenue) AS Average_Spend_Per_Customer
FROM (SELECT Customer_id, SUM(Revenue) AS Total_Revenue
    FROM SALES
