...
SELECT S.Order_id, S.Item_id, S.Quantity, S.Revenue FROM SALES S
JOIN Order_Revenue ORR ON S.Order_id = ORR.Order_id
WHERE ORR.Total_Revenue = (SELECT MAX(Total_Revenue) FROM Order_Revenue);